...
// Great = 80 - 6*OD, Ok = 140 - 8*OD, Meh = 200 - 10*OD (all floored - 0.5ms)
// Miss window is fixed 400ms.
...
// Clear RPM (to not miss): DifficultyRange(OD, 90, 150, 225)
// Complete RPM (full score): DifficultyRange(OD, 250, 380, 430)
