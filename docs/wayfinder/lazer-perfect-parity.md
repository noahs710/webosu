...
- **T03 — Finish Track B skin conformance** (`task`, HITL) — D7 @2x whitelist extend + beatmap-skin @2x disable + remaining tasks.md §5 items (5.1, 5.2, 5.4, 5.8, 5.11). D8 (ApproachCircle) moved to T15 (done). D9 (animated judgements) is T16. `docs/wayfinder/tickets/T03-skin-conformance-wiring.md`
