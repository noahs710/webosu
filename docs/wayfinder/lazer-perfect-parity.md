...
- **T06 — Rollout: flip the 4 feature flags on, remove legacy code, ship** (`grilling`, HITL) — blocked by T03, T04. `docs/wayfinder/tickets/T06-rollout-flags.md`
...
- [T13 — Fix the 4 real lazer-parity bugs (D1–D4)](tickets/T13-fix-audit-parity-bugs.md) — `task`, HITL. Resolved: commit `0e05b2d`. Score V2 production formula wired (scoreTyped method), HP cap removed, last-combo bonus applied, circle radius fixed. Tests 87 → 110. See Decisions so far.
