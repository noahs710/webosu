...
async function main(){
  if(!(await wait("http://localhost:5302/browse"))){console.log("vite preview not ready",ve);process.exit(1);}
  ...
  await p.goto("http://localhost:5302/browse?perf=1",{waitUntil:"load",timeout:30000});
