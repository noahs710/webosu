...
async function main(){
  if(!(await wait("http://localhost:5188/browse"))){console.log("vite not ready",ve);process.exit(1);}
  ...
  await p.goto("http://localhost:5188/browse",{waitUntil:"load",timeout:30000});
