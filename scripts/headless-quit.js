...
async function main(){
  if(!(await wait("http://localhost:5204/index-v2.html"))){console.log("vite not ready",ve);process.exit(1);}
  ...
  await p.goto("http://localhost:5204/index-v2.html",{waitUntil:"load",timeout:30000});
