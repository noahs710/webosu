...
// index-v2.html in chromium, and checks the ESM bootstrap actually runs:
...
async function main() {
  if (!(await wait("http://localhost:5176/index-v2.html"))) { console.log("vite not ready"); console.log(viteErr); process.exit(1); }
