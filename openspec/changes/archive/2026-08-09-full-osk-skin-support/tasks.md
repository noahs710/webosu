...
- [x] T1: Create `src/game/skin-loader.js` — the unified .osk skin loading module
...
- [x] T2: Integrate skin-loader into `initgame.js`
...
- [x] T3: Add judgement textures to `window.Skin` when skin is loaded
...
- [x] T4: Modify `playback.js` `createJudgement()` and `invokeJudgement()`
...
- [x] T11: Update settings page — unified .osk import
...
- [x] T12: Test with clearblack.osk and dokidoki.osk
